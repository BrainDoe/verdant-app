    ...
    <div>
         <Row>
          <Col sm={12} md={12} lg={12} className="py-3">
            <h6>Home <ChevronRight /> <span className="text-primary">Invoice Upload</span></h6>
          </Col>
      </Row>
        <Row>
      ...
      <section className="py-3 my-5 bg-white">
         <Row  className="mx-auto py-2">
          <Col sm={12} md={12} lg={12}>
            ...
            <h5 className="pt-2">Step 1: Enter Recievers Details<span className="text-danger">*</span> </h5>
          </Col>
        </Row>
        <Form>
           <Row  className="mx-auto py-2">
        ...
        <hr />
         <Row  className="mx-auto py-2">
          <Col sm={12} md={12} lg={12}>
            <h5 className="pt-2">Step 2: Invoice Details</h5>
          </Col>
        </Row>
        <Form>
           <Row  className="mx-auto py-2">
