...
import { User, Heart, Cart, CartFill } from 'react-bootstrap-icons'
    ...
    <div>
      <Row>
        <Col sm={12} md={12} lg={12} className="py-3">
          <h6 style={{ fontSize: '18px', fontWeight: '400', lineHeight: '26.44px' }}>Home <ChevronRight /> <span className="text-primary" style={{ fontSize: '18px', fontWeight: '400', lineHeight: '26.44px' }}>My Orders</span></h6>
        </Col>
      </Row>
      ...
      <Col md={3} lg={4}>
        ...
        <Col md={9} lg={8}>
          <Card>
            <Card.Body>           
              <Row>
                <Col sm={12} md={12} lg={12} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', padding: '50px 0' }}>
                  <div>
                    <img src={noOrders} alt="No Order Icon" style={{ width: '250px' }}/>
                  </div>
                  <h5 style={{ fontSize: '20px', fontWeigt: '500', lineHeight: '26.9px' }}>No orders yet!!</h5>
                  <p style={{ fontSize: '16px', fontWeigt: '400', lineHeight: '21.52px' }}>You have not placed an order recently</p>
                  <div style={{ width: '30%', textAlign: 'center' }}>
                    <input className="btn btn-primary btn-block" type="submit" value="Continue Shopping" />
                  </div>
                </Col>                
              </Row>             
            </Card.Body>
