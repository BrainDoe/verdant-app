  ...
  const [showInfo4, setShowInfo4] = useState(false)
    ...
    useEffect(() => {
      if (showInfo1 === true) {
          ...
          setShowInfo3(false)
          setShowInfo4(false)
      } else if (showInfo2 === true) {
          setShowInfo1(false)
          setShowInfo3(false)
          setShowInfo4(false)
      } else if(showInfo3 === true) {
          setShowInfo1(false)
          setShowInfo2(false)
          setShowInfo4(false)
      } else if(showInfo4 === true) {
           setShowInfo1(false)
          setShowInfo2(false)
          setShowInfo3(false)
        }
    ...
    <>
      ...
      <div className="row">
        <div  className=" col-md-6 d-none d-md-block">
          {showInfo1 && <div className="solution1" style={{ height:' 400px' }}>
            
          </div>}
          {
            showInfo2 && <div className="solution2" style={{ height: ' 400px' }}>
            
          </div>}
          {
            showInfo3 && <div className="solution3" style={{ height: ' 400px' }}>
            
          </div>}
          {
            showInfo4 && <div className="solution4" style={{ height: ' 400px' }}>
